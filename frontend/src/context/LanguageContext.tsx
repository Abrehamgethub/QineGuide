...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'mentors.viewProfile': 'View LinkedIn Profile',
    ...
    'mentors.ctaTitle': 'Are you an experienced professional?',
    'mentors.ctaSubtitle': 'Help shape the next generation of Ethiopian tech talent',
    'mentors.applicationTitle': 'Mentor Application',
    'mentors.fullName': 'Full Name',
    'mentors.email': 'Email',
    'mentors.phone': 'Phone',
    'mentors.linkedinUrl': 'LinkedIn Profile URL',
    'mentors.expertise': 'Area of Expertise',
    'mentors.bio': 'Short Bio',
    'mentors.submitApplication': 'Submit Application',
    'mentors.submitting': 'Submitting...',
    'mentors.submitSuccess': 'Application Submitted!',
    'mentors.submitSuccessMessage': 'Your application has been submitted. An admin will review it.',
    'mentors.submitError': 'Failed to submit application. Please try again.',
    ...
    'career.enterGoal': 'Please enter a career goal',
    ...
    'auth.configError': 'Configuration error. Please contact support.',
